...
export const ChatItem = ({
  ...
  return (
    <div className="relative group flex flex-center hover:bg-black/5 p-4 w-full transition">
                    ...
                    <FormItem className="flex-1">
                      <FormControl>
                        <div className="relative w-full">
                          <Input
                            disabled={isLoading}
                            className="p-2 bg-zinc-200/50 dark:bg-zinc-700/75 border-none border-0
